...
import com.spaceneochat.adapter.RecentConversationsAdapter;
import com.spaceneochat.admin.SignIn;
import com.spaceneochat.databinding.ActivityHomeBinding;
import com.spaceneochat.listeners.ConversionListener;
        ...
        if (value != null) {
            for (DocumentChange documentChange : value.getDocumentChanges()) {
                if (documentChange.getType() == DocumentChange.Type.ADDED) {
                    ...
                    if (preferenceManger.getSting(Constants.KEY_USER_ID).equals(senderId)) {
